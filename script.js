...
document.querySelectorAll('.lh-gauge__percentage').forEach(el => el.textContent = 100);
document.querySelectorAll('.lh-exp-gauge__percentage').forEach(el => el.textContent = 100);

document.querySelectorAll('.Kb94Vd[jscontroller], .lh-audit--fail, .lh-audit--average').forEach(el => el.remove());
...
console.log('[fakespeed] PageSpeed Faked!');